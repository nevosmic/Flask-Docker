...
scp "/var/lib/jenkins/workspace/Bynet_attendance/docker-compose.yml" "ec2-user@${mechine}:/home/ec2-user/final-proj/docker-compose.yml"
scp "/var/lib/jenkins/workspace/Bynet_attendance/.env" "ec2-user@${mechine}:/home/ec2-user/final-proj/.env"
