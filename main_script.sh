...
ssh -i $SSH_TEST_KEY ec2-user@test "mkdir -p /home/ec2-user/final-proj"
...
ssh -i $SSH_TEST_KEY ec2-user@test "ls -a"
ssh -i $SSH_TEST_KEY ec2-user@test "cd /home/ec2-user/final-proj;docker-compose up --no-build -d;sleep 20;docker container ls; docker-compose down"
